//#include <fstream> // file Preprocessing:file stream
//#include <iostream>
//#include <iomanip>
//#include <string>
//#include <cstdlib>
...
//    string  whoFillingTax(){
//outClientFile<<"----------------------------------------------------------------\n";
//  cout<<"Please enter, your full name !\n";
//  getline(cin,UserName);
//  outClientFile<<"the USA Basic Federal Tax Formula 2015\n";
//  outClientFile<<"the user name  is :"<<UserName;
...
///*int main()
//{
//	// ofstream comstructor open file
//	string client=whoFillingTax();
//	string ClientFile=client+".txt";
//	
//	outClientFile.open(ClientFile,ios::out);
//	
//		if(!outClientFile){
//		cerr<<"I'am sorry, but "<<ClientFile<<" cannot be opened/created."<< endl;
//		exit(1);
//		}
//		*/
////fout.open("data.txt");
